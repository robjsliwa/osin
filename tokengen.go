...
func (a *AccessTokenGenDefault) GenerateAccessToken(data *AccessData, generaterefresh, skipGenerateAccessToken bool) (accesstoken string, refreshtoken string, accesstokenduration uint64, err error) {
